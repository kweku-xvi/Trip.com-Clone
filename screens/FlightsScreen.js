    ...
    <ScrollView style={{ backgroundColor: "#f0f0f0" }}>
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-evenly" }}>
        ...
        <View style={{ alignItems: "center", padding: 5 }}>
          ...
          >
            <MaterialCommunityIcons name="diamond" size={24} color="purple" />
          </Pressable>
          <Text style={{ top: 5 }}>Charter Flights</Text>
        </View>
        ...
        <View style={{ alignItems: "center", padding: 5 }}>
          ...
          >
            <Foundation name="projection-screen" size={24} color="green" />
          </Pressable>
          <Text style={{ top: 5 }}>Flight Status</Text>
        </View>
        ...
        <View style={{ alignItems: "center", padding: 5 }}>
          ...
          >
            <FontAwesome5 name="book" size={24} color="orange" />
          </Pressable>
          <Text style={{ top: 5 }}>My Bookings</Text>
        </View>
      </View>
